...
let errorXBtn = document.querySelector("#errorXBtn");

checkBtn.addEventListener("click", function () {
  let userInput = document.querySelector("#userInput").value;
  let userResult = document.querySelectorAll(".resultInput>input");
  let i = 0;
  let binaryNum = 0;
  let octalNum = 0;
...
errorXBtn.addEventListener("click", function(){
  let errorBox = document.querySelector("#errorBox");
